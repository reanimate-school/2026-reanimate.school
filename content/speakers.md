...
Frédérick Maheux is a noise musician and practice-based researcher whose work weaves together technological détournement, transgression, and critical theory. After probing digital subcultures through the feature documentaries Art/Crime (2011), ANA (2015), and Drug Porn (2018), he has, since 2020, shifted his focus toward experimental video games such as Exophilie and AI-driven interactive installations like Cyborg T.A.R.O.T., interrogating noise, glitch, and post-human speculation.

A doctoral candidate in communication at UQAM, Maheux studies how noise functions within creative and collaborative processes through game-based research-creation. His projects have been presented at festivals and conferences, including ECRÃ, iDMAa, DiGRA, and Beyond Humanism. His latest article, Au-delà des art games : la transposition vidéoludique de l’espace d’exposition comme expansion de l’œuvre artistique, appears in Pour d’autres espèces d’espace (Châtelet et al., 2025).
